...
<div class="container-fluid">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h6 class="mb-0">Sales Overview (Last 1 month)</h6>
                </div>
                <div class="card-body">
                    <canvas id="salesChart" height="150"></canvas>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="progress mb-3" style="height: 20px;">
                        <div class="progress-bar bg-success" role="progressbar" 
                             style="width: {{ round($totalSales > 0 ? ($totalSales/100) * 100 : 0) }}%">
                             {{ $totalSales }}
                        </div>
                    </div>
                    <p>Stock Updates</p>
                    <div class="progress mb-3" style="height: 20px;">
                        <div class="progress-bar bg-primary" role="progressbar" 
                             style="width: {{ round($totalProducts > 0 ? ($totalProducts/100) * 100 : 0) }}%">
                             {{ $totalProducts }}
                        </div>
                    </div>
                    <p>Customer Engagement</p>
                    <div class="progress mb-3" style="height: 20px;">
                        <div class="progress-bar bg-warning" role="progressbar" 
                             style="width: {{ round($totalCustomers > 0 ? ($totalCustomers/100) * 100 : 0) }}%">
                             {{ $totalCustomers }}
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            <span>Pending Orders</span>
                            <strong>{{ 10 }}</strong> <!-- Example static -->
                        </li>
                    </ul>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const salesChart = new Chart(salesCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Sales Amount ($)',
                data: [1200, 1500, 1100, 1800, 1700, 1900, 2000, 2200, 2100, 2500, 2400, 2300],
                backgroundColor: 'rgba(54, 162, 235, 0.6)',
                borderColor: 'rgba(54, 162, 235, 1)',
                borderWidth: 1
            }]
